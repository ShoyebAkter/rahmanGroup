...
const DueToExpire = () => {
  ...
  const generateReport = (elementId) => {
    ...
    html2pdf(element, {
      margin: 2,
      filename: `passport due-${getReadableTimestamp()}.pdf`,
  ...
  return (
    <div className='w-full flex h-full flex-col items-center justify-between relative gap-3'>
      ...
      <div className='w-full flex justify-center mt-5 gap-2 p-2'>
...

        {
            ...
            <>
                ...
                <CSVLink
                data={flattenedData}
                filename={`passports due-`+ getReadableTimestamp()}
...

      {
        ...
        <h1 className='text-[14pt] self-center mt-2'>Report Listing- Passports Due to Expire</h1>
            ...
            <div className="overflow-x-auto">
                ...
                <tbody className="text-gray-600 text-sm font-light">
                    ...
                    <tr key={index} className="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td className="py-3 px-6 text-left">{Math.abs(parseInt(item.days)) + " days to go"}</td>
                    </tr>
                    ))}
                </tbody>
                </table>

...
const ExpiredVisa = () => {
  ...
  const generateReport = (elementId) => {
    ...
    html2pdf(element, {
      margin: 2,
      filename: `Expired Visa-${getReadableTimestamp()}.pdf`,
  ...
  return (
    <div className='w-full flex h-full flex-col items-center justify-between relative gap-3'>
      ...
      <div className='w-full flex justify-center mt-5 gap-2 p-2'>
...

        {
            ...
            <>
                ...
                <CSVLink
                data={flattenedData}
                filename={`expired visas-`+ getReadableTimestamp()}
...

      {
        ...
        <h1 className='text-[14pt] self-center mt-2'>Report Listing- Expired Visas</h1>
